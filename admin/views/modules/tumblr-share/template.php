<?php
    $tumblr_preview_component = apply_filters('tumblr_preview_component', array(''));
?>
<div class="sb-social-media-share tumblr">
    <div class="header">
        <ul>
            <li class="icon">
                <span><font-awesome-icon :icon="['fab', 'tumblr']" /></span>
            </li>
    ...
    <form>
        ...
        <?php
         echo $tumblr_preview_component[0];
        ?>
