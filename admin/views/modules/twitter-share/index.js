...
Vue.component("TwitterShare", {
  template: "#rx-sb-module-twitter-share",
  ...
  methods: {
    ...
    renderMediaUploader: function() {
      ...
      var file_frame,
        image_url,
        delImgLink = document.getElementById("delete-img-tw");
      ...
      file_frame.on("insert", function() {
        ...
        console.log(sizes);
        if (sizes.medium !== undefined) image_url = sizes.medium.url;
        else image_url = attachment.url;

        document.getElementById("feature-image-tw").src = image_url;
        document
          .getElementById("uploadeImgLabeltw")
          .classList.add("img-uploaded");
      });
      file_frame.open();

      delImgLink.on("click", function(event) {
        event.preventDefault();
        document.getElementById("feature-image-tw").src = "";
    ...
    shareNow: function() {
      ...
      this.$store.dispatch("instantShareModule/instantShareTw",
          {
  ...
  mounted() {
    wp.editor.initialize("wysiwyg-tw", {
      tinymce: true
    });
  }
});
