<?php
    // $pinterest_preview_component = apply_filters('twitter_preview_component', array(''));
?>
<div class="sb-social-media-share pinterest">
    <div class="header">
        <ul>
            <li class="icon">
                <span><font-awesome-icon :icon="['fab', 'pinterest-p']" /></span>
            </li>
    ...
    <form>
        ...
        <?php
         // echo $pinterest_preview_component[0];
        ?>
