...
Vue.component('FacebookShare', {
    template: '#rx-sb-module-facebook-share',
    ...
    computed: {
        ...mapGetters({
            ...
            shareToastMessage: 'instantShareModule/shareToastMessage',
        }),
    },
    methods: {
        append(emoji) {
        ...
        renderMediaUploader: function () {
            ...
            file_frame.on( 'insert', function() {
                ...
                document.getElementById('feature-image-fb').src = image_url;
                document.getElementById('uploadeImgLabelfb').classList.add("img-uploaded");
            });
            file_frame.open();
        },
        ...
        shareNow: function() {
            ...
            this.$store.dispatch('instantShareModule/instantShareFb',
                  {
    ...
    watch: {
        shareToastMessages(newValue, oldValue) {
    ...
    mounted() {
        wp.editor.initialize('wysiwyg-fb', {
            tinymce: true
        })
    },
});
